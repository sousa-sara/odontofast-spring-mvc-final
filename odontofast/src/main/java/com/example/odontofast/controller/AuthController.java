...
public class AuthController {
    ...
    // Classe auxiliar para representar um agendamento
    public static class Appointment {
        ...
        public Appointment(String time, String patientName, String procedure, String status) {
            this.time = time;
    ...
    private String getFormattedDate(Locale locale) {
        ...
        DateTimeFormatter formatter = DateTimeFormatter
                .ofPattern(locale.getLanguage().equals("pt") ? "dd 'de' MMMM 'de' yyyy" : "MMMM d, yyyy")
                .withLocale(locale);
    ...
    @GetMapping("/home")
    public String exibirHome(Authentication authentication, Model model, Locale locale) {
        ...
        String formattedDate = getFormattedDate(locale);
        model.addAttribute("formattedDate", formattedDate);

        // Lista de agendamentos (exemplo estático, pode vir de um serviço ou banco)
        List<Appointment> appointments = Arrays.asList(
                new Appointment("09:00", "Maria Silva", "limpeza", "confirmado"),
                new Appointment("10:30", "João Pereira", "extracao", "pendente"),
                new Appointment("14:00", "Ana Costa", "clareamento", "confirmado"),
                new Appointment("16:00", "Pedro Almeida", "consulta", "cancelado"));
    ...
    public String exibirAgendamentos(Authentication authentication, Model model, Locale locale) {
        if (authentication == null) {
            return "redirect:/dentista/login";
        }
    ...
    public ResponseEntity<Dentista> getPerfilApi(Authentication authentication) {
        if (authentication == null) {
